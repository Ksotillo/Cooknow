...
import { materialTheme, recipes, Images } from '../constants/';
import { Select, Icon, Header, Recipe, Switch } from '../components/';
        ...
        <Block flex>
          <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
            ...
            <Block flex card shadow style={styles.category}>
              <ImageBackground
                source={{ uri: Images.recipes['Accessories'] }}
      ...
      <Block flex style={[styles.group, { paddingBottom: theme.SIZES.BASE * 5 }]}>
        ...
        <Block style={{ marginHorizontal: theme.SIZES.BASE * 2 }}>
          ...
          <Block row space="between" style={{ marginTop: theme.SIZES.BASE, flexWrap: 'wrap' }} >
            {Images.MyRecipes.map((img, index) => (
